#ifndef EXAMPLES_ANALYTICAL_APPS_DDT_DDT_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_DDT_DDT_CONTEXT_H_
...
class DDTContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using depth_type = int64_t;
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit DDTContext(const FRAG_T& fragment)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_DDT_DDT_CONTEXT_H_
